...
test('total = unique changes; amendments counted once (#6)', ()=>{
  const orig=['alpha beta gamma delta','THE MOVED PARAGRAPH HAS MANY WORDS HERE','to be deleted entirely x y z'].map(P);
  const rev =['alpha beta gamma echo','a brand new inserted paragraph q r s','THE MOVED PARAGRAPH HAS MANY WORDS HERE'].map(P);
  ...
  // component tiles keep v1.1.4 meaning: amendment contributes to both ins and del
